...
class Game(models.Model):
    ...
    flips = models.IntegerField(choices=FLIP_CHOICES)
    piles = models.IntegerField(choices=PILE_CHOICES)
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Game - flips: {self.get_flips_display()}, piles: {self.get_piles_display()}"
